...
describe("Parsing of metadata saved by 'Picard' in audio files", () => {
    ...
    function hasReleaseData(inputTagType) {
        switch (inputTagType) {
    ...
    function hasOriginalData(inputTagType) {
        switch (inputTagType) {
            case "ID3v2.3": // has original year, not the original date
                return false;
            default:
     ...
     */
    function checkCommonMapping(inputTagType, common) {
    ...
    describe("Vorbis mappings", () => {
         ...
         */
        function checkVorbisTags(vorbis, dataformat) {
            // Compare expectedCommonTags with result.common
    ...
    it("should map M4A / (Apple) iTunes header", () => {
        ...
        function check_iTunes_Tags(iTunes) {
    ...
    it("should map WMA/ASF header", () => {
        ...
        function check_asf_Tags(native) {
...
//# sourceMappingURL=test-picard-parsing.js.map