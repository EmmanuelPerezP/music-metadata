...
const ID3v2Parser_1 = require("../src/id3v2/ID3v2Parser");
...
describe("Extract metadata from ID3v2.3 header", () => {
    it("should parse a raw ID3v2.3 header", () => {
        ...
        const metadata = new MetadataCollector_1.MetadataCollector({});
        return strtok.fromFile(filePath).then(tokenizer => {
            return ID3v2Parser_1.ID3v2Parser.getInstance().parse(metadata, tokenizer, {}).then(() => {
