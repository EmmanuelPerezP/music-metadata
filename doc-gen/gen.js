...
const GenericTagTypes_1 = require("../lib/common/GenericTagTypes");
...
function getNativeSourceTags(nativeType, commonTag) {
    const result = [];
...
function write(out) {
    ...
    const commonDescriptionDict = JSON.parse(json);
    ...
    for (const commonTagKey in GenericTagTypes_1.commonTags) {
        ...
        const multiplicity = GenericTagTypes_1.commonTags[commonTagKey].multiple ? '*' : '1';
